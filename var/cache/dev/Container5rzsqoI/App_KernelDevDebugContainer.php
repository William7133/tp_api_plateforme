...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getAnnotatedAppEntityCategoriesApiPlatformCoreBridgeDoctrineOrmFilterSearchFilterService()
    {
        ...
        return $this->privates['annotated_app_entity_categories_api_platform_core_bridge_doctrine_orm_filter_search_filter'] = new \ApiPlatform\Core\Bridge\Doctrine\Orm\Filter\SearchFilter(($this->services['doctrine'] ?? $this->getDoctrineService()), NULL, ($this->privates['api_platform.iri_converter'] ?? $this->getApiPlatform_IriConverterService()), ($this->privates['property_accessor'] ?? $this->getPropertyAccessorService()), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())), ['nom' => 'ipartial'], ($this->privates['api_platform.identifiers_extractor.cached'] ?? $this->getApiPlatform_IdentifiersExtractor_CachedService()), ($this->privates['serializer.name_converter.metadata_aware'] ?? $this->getSerializer_NameConverter_MetadataAwareService()));
    }
    ...
    protected function getAnnotatedAppEntityProduitApiPlatformCoreBridgeDoctrineOrmFilterRangeFilterService()
    {
        ...
        return $this->privates['annotated_app_entity_produit_api_platform_core_bridge_doctrine_orm_filter_range_filter'] = new \ApiPlatform\Core\Bridge\Doctrine\Orm\Filter\RangeFilter(($this->services['doctrine'] ?? $this->getDoctrineService()), NULL, ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())), ['prix' => NULL], ($this->privates['serializer.name_converter.metadata_aware'] ?? $this->getSerializer_NameConverter_MetadataAwareService()));
    }
